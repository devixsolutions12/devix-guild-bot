...
[FFD700]✨ Name on instagram : [FFFFFF] @raostarrr❤️  
[FF0000]╚══════════╝
[FFD700]✨ Developer —͟͞͞ </> Raostar CODEX ❄️  ⚡
"""
...
"""
                        ...
                        if inPuTMsG.strip() == '/stop_auto':
                            ...
                            # global auto_start_task, stop_auto  <-- REMOVED (Already global above)
                        ...
                        if inPuTMsG.strip().lower() in ("help", "/help", "menu", "/menu", "commands"):
                            ...
                            # Header
                            header = f"[b][c]{get_random_color()}Welcome to devix guild bot"
...
async def MaiiiinE():
    Uid , Pw = '4365303330','A4065B4F849D2B55977A05A31CC5CB71CA61A0DFD60B6BAB69BF94F567123F00'
...
def handle_keyboard_interrupt(signum, frame):
    ...
    print("👋 Thanks for using DEVIX GUILD BOT")
    sys.exit(0)
